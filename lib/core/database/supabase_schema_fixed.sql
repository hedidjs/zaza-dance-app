-- Supabase Database Schema for Zaza Dance App (Fixed Version)
...
('ביצוע מדהים של מיה', 'מיה מבצעת רצף ברייקדאנס מושלם', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', 'https://images.unsplash.com/photo-1547153760-18fc86324498?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'video', (SELECT id FROM categories WHERE name_he = 'ברייקדאנס'), true, ARRAY['ברייקדאנס', 'תלמידים', 'ביצוע']),
('סשן אימון קבוצתי', 'האימון השבועי של הקבוצה המתקדמת', 'https://images.unsplash.com/photo-1594736797933-d0201ba2fe65?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1594736797933-d0201ba2fe65?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'image', (SELECT id FROM categories WHERE name_he = 'היפ הופ קלאסי'), false, ARRAY['קבוצתי', 'אימון']),
('תמונת הקבוצה', 'תמונה משותפת אחרי התחרות', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'image', (SELECT id FROM categories WHERE name_he = 'אירועים'), true, ARRAY['קבוצה', 'תחרות']);
...
('יסודות הברייקדאנס למתחילים', 'למד את התנועות הבסיסיות של ברייקדאנס', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4', 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 900, 'beginner', (SELECT id FROM categories WHERE name_he = 'ברייקדאנס'), 'רועי המדריך', true, ARRAY['למתחילים', 'יסודות']),
('פופינג מתקדם', 'טכניקות מתקדמות בפופינג', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 1200, 'advanced', (SELECT id FROM categories WHERE name_he = 'פופינג'), 'שרון המדריכה', false, ARRAY['מתקדם', 'טכניקות']),
('היפ הופ לילדים', 'מדריך מיוחד לילדים צעירים', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', 'https://images.unsplash.com/photo-1545558014-8692077e9b5c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 600, 'beginner', (SELECT id FROM categories WHERE name_he = 'היפ הופ קלאסי'), 'דני המדריך', true, ARRAY['ילדים', 'כיף']);

-- Sample updates/news
INSERT INTO updates (title_he, content_he, excerpt_he, image_url, update_type, is_pinned, author_name, tags) VALUES
('🔥 תחרות ההיפ הופ השנתית!', 'אנחנו גאים להודיע על תחרות ההיפ הופ השנתית שלנו! התחרות תתקיים בחודש הבא ופתוחה לכל הרמות. פרסים מדהימים מחכים לזוכים!', 'תחרות ההיפ הופ השנתית - הרשמה פתוחה!', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'announcement', true, 'צוות זזה דאנס', ARRAY['תחרות', 'הודעה']),
('⭐ מיה זוכה במקום הראשון!', 'התלמידה שלנו מיה זכתה במקום הראשון בתחרות הארצית! אנחנו כל כך גאים בה ובהישג המדהים הזה. מיה מראה לנו שבעבודה קשה ומסירות אפשר להגיע לכל מקום!', 'מיה מככבת בתחרות הארצית', 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'achievement', false, 'רועי המדריך', ARRAY['הישג', 'תלמידים']),
('💡 טיפ השבוע: שיפור הקצב', 'השבוע נלמד איך לשפר את הקצב שלנו בריקוד. הסוד הוא להקשיב למוזיקה באמת ולהרגיש אותה בגוף. תתרגלו עם מטרונום ותבחינו בשיפור!', 'טיפים לשיפור הקצב בריקוד', 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80', 'tip', false, 'שרון המדריכה', ARRAY['טיפים', 'קצב']);
