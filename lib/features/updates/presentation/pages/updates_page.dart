...
class _UpdatesPageState extends State<UpdatesPage>
  ...
  final List<UpdateModel> _allUpdates = [
    UpdateModel(
      ...
      content: 'אנחנו גאים להכריז על התחרות השנתית של הסטודיו! הרישום פתוח לכל הרמות. פרסים מדהימים מחכים לכם!',
      author: 'ההנהלה',
    ...
    UpdateModel(
      ...
      updateType: UpdateType.studentSpotlight,
      isPinned: false,
      isNew: true,
      likeCount: 67,
      commentCount: 23,
    ...
    UpdateModel(
      ...
      updateType: UpdateType.instructorTip,
      isPinned: false,
      isNew: false,
      likeCount: 34,
      commentCount: 8,
  ...
  List<UpdateModel> _getFilteredUpdates(int categoryIndex) {
    ...
    switch (categoryIndex) {
      ...
      case 2: // הישגי תלמידים
        filtered = filtered.where((u) => u.updateType == UpdateType.studentSpotlight).toList();
        break;
  ...
  Color _getUpdateTypeColor(UpdateType type) {
    switch (type) {
      ...
      case UpdateType.studentSpotlight:
