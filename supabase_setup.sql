...
-- Note: These need to be created through the Dashboard, not SQL
...
3. 'gallery' - For gallery images and videos
   - Public: true
   - File size limit: 100MB
   - Allowed mime types: image/*, video/*

4. 'thumbnails' - For video thumbnails and preview images
   - Public: true
   - File size limit: 5MB
   - Allowed mime types: image/jpeg, image/png, image/webp

5. 'updates' - For update/news images
   - Public: true
...
-- Insert admin user (you'll need to register this user through auth first)
